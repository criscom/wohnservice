...
To use these stylesheets, rename the files and wohnservice with the name of your theme.
...
wohnservice-alpha-default-narrow.css  
...
wohnservice-alpha-default-normal.css
...
wohnservice-alpha-default-wide.css
